...
const applyTheme = (isDark) => {
  if (isDark) {
    ...
    firstTechSkillsList.querySelectorAll('.tech-skills-item-block').forEach((block) => {
    ...
    secondTechSkillsList.querySelectorAll('.tech-skills-item-block').forEach((block) => {
    ...
    modalInput.style.setProperty('--placeholder-color', 'rgba(240, 240, 240, 0.60)');
    ...
    modalTextArea.style.setProperty('--placeholder-color', 'rgba(240, 240, 240, 0.60)');
